...
export default function HowItWorksPage() {
  return (
    <div className="min-h-screen bg-[#FFFBF5]">
      {/* Navbar */}
      <nav className="sticky top-0 z-50 flex items-center justify-between border-b border-[rgba(0,0,0,0.06)] bg-[rgba(255,251,245,0.88)] px-8 py-4 backdrop-blur-[20px]">
        <Link href="/" className="no-underline">
          <img src="/lemon-logo.png" alt="Lemon" className="h-12 w-auto" />
        </Link>
      ...
      {/* Hero */}
      <div className="mx-auto max-w-[960px] px-6 pb-24 pt-20 text-center">
      ...
      <div className="mx-auto max-w-[960px] px-6 pb-24">
        <div className="grid gap-5 [grid-template-columns:repeat(auto-fit,minmax(280px,1fr))]">
          {STEPS.map((step, i) => (
            <div
              key={step.n}
              className={`rounded-[28px] px-9 py-11 border ${
                i === 1
        ...
        <div className="mt-20 text-center">
          <Link
            href="/onboard"
            className="inline-block rounded-full px-14 py-[18px] text-[18px] font-bold tracking-[-0.01em] text-white no-underline [background:linear-gradient(135deg,#e8a820,#c8820a)] [box-shadow:0_8px_32px_rgba(200,130,10,0.35)] [font-family:Inter,sans-serif]"
          >
            Create your agent
          </Link>
      ...
      {/* Footer */}
      <footer className="border-t border-[rgba(0,0,0,0.06)] bg-[#FFFBF5] px-8 py-6">
